                    ...
                    <div className='grid flex-1 gap-x-8 gap-y-6 py-4 pr-8 md:grid-cols-2 md:px-0 md:py-8 lg:py-8 lg:pr-8'>
                      <div className='grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4'>
                        ...
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Buying Guide</h5>
                        ...
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Selling Guide</h5>
                            <p className='hidden text-sm md:block'>
                              Maximize your home's value with our tips.
                            </p>
                          </div>
                        </a>
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Market Insights</h5>
                            <p className='hidden text-sm md:block'>
                              Stay updated on Denver's real estate trends.
                            </p>
                          </div>
                        </a>
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            ...
                            <p className='hidden text-sm md:block'>
                              Discover expert advice and local insights.
                            </p>
                          </div>
                        </a>
                      </div>
                      <div className='grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4'>
                        ...
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Home Tips</h5>
                            <p className='hidden text-sm md:block'>
                              Learn how to enhance your living space.
                            </p>
                          </div>
                        </a>
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            ...
                            <p className='hidden text-sm md:block'>
                              Explore the best neighborhoods in Denver.
                            </p>
                          </div>
                        </a>
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Investment Advice</h5>
                            <p className='hidden text-sm md:block'>
                        ...
                        <a
                          ...
                          <div className='flex flex-col items-start justify-center'>
                            <h5 className='font-semibold'>Market Reports</h5>
                            <p className='hidden text-sm md:block'>
                              Get the latest data on home sales.
                            </p>
                          </div>
                        </a>
                      </div>
                        ...
                        <div className='grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start gap-y-2 lg:grid-rows-[auto]'>
                          <a
                            ...
                            <div className='rt-4 mt-4 flex flex-col justify-start md:mt-0'>
                              <h5 className='mb-1 font-semibold'>Top Tips</h5>
                              <p className='text-sm'>
                                Essential advice for buyers and sellers.
                              </p>
                          ...
                          <a
                            ...
                            <div className='rt-4 mt-4 flex flex-col justify-start md:mt-0'>
                              ...
                              <p className='text-sm'>
                                Stay informed about local real estate changes.
                              </p>
                              <div className='mt-1.5'>
                                <Button
                                  title='Read more'
